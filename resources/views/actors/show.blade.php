...
<div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flec-col md:flex-row">
        ...
        <div class="md:ml-24">
            ...
            <div class="flex flex-wrap items-center t ext-gray-400 text-sm mt-2">
                <img src="/img/cake.png" width="16" alt="" style="color:white;">
...
<div class="credits border-b border-gray-800">
    <div class="container mx-auto px-4 py-16">
        ...
        <ul class="list-disc leading-loose pl-5 mt-8">
            ...
            <li class="">{{$credit['release_year']}} &middot; <strong>{{$credit['title']}} as {{$credit['character']}}</strong></li>
            <br>
            @endforeach
        </ul>
    </div>
